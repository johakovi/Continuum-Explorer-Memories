    ...
    val baseExtendedColors = when {
        isVeryDark -> {
            ExtendedColors(
                ...
                homeIcon = if (iconTheme == IconTheme.COLOURFUL) ThemeHome else if (iconTheme == IconTheme.COLOURFULDUO) ThemeHomeDuo else VeryDarkIcons,
                ...
                homeIconDuo = if (iconTheme == IconTheme.COLOURFULDUO) ThemeHomeDuo else VeryDarkIcons,
        ...
        isVeryLight -> {
            ExtendedColors(
                ...
                homeIcon = if (iconTheme == IconTheme.COLOURFUL) ThemeHome else if (iconTheme == IconTheme.COLOURFULDUO) ThemeHomeDuo else VeryLightIcons,
                ...
                homeIconDuo = if (iconTheme == IconTheme.COLOURFULDUO) ThemeHomeDuo else VeryLightIcons,
            ...
            ExtendedColors(
                ...
                homeIcon = if (iconTheme == IconTheme.COLOURFUL) ThemeHome else if (iconTheme == IconTheme.COLOURFULDUO) ThemeHomeDuo else primary,
                ...
                homeIconDuo = if (iconTheme == IconTheme.COLOURFULDUO) ThemeHomeDuo else primary,
